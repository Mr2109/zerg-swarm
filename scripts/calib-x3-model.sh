...
#   # 多模态例（带 mmproj）：
#   #   bash calib-x3-model.sh example-35b-v2 /data/models/example-35b-v2/example-35b-v2-Q4_K_M.gguf \
#   #        /home/g01/llama-k2/build-k2/bin/llama-server 262144 9699 --mmproj /data/models/example-35b-v2/mmproj-example-35b-v2-BF16.gguf
#
