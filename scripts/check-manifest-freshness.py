...
用法：
  python3 scripts/check-manifest-freshness.py <manifest.json> [--repo <仓>] [--max-age-hours N] [--strict]
  python3 scripts/check-manifest-freshness.py --self-test     # 正/负用例自测；不通过即拒绝服务
"""
import argparse
import datetime
import json
