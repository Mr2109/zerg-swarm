...
// K2Horizon IFM example-moe-36b 家族适配器（example-moe-36b 架构）。
...
// 'example-moe-36b'）——必须用 IFM fork（/home/g01/llama-k2/build-k2，model/K2Horizon 分支），
...
// GGUF 内嵌 chat template 需要 --jinja 启用（同 example-35b-v2/qwen4 系）。
type K2Horizon struct{}

func (a *K2Horizon) Name() string { return "example-moe-36b" } // 前缀匹配 example-moe-36b-*（MoVA-36B 等）

// RequiresNonMainlineEngine 实现 modeladapter.NonMainlineEngine（P1）：
// 主线 llama.cpp **不支持** example-moe-36b 架构（报 unknown model architecture）⇒ 这枚卵**必须**
