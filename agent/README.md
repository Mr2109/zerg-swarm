...
example-35b-v2:
  ...
  file: /data/models/example-35b-v2/example-35b-v2-Q4_K_M.gguf
  mem_gb: 21
  modality: multimodal
  mmproj: /data/models/example-35b-v2/mmproj-example-35b-v2-BF16.gguf   # 可选：视觉投影
  chat_template: ~/.zerg/example-35b-v2_chat_template.jinja             # 可选：覆盖内嵌模板
```
