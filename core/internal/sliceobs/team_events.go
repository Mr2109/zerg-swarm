...
//	    同一取值另有一处独立来源：docs/01-设计/设计-内建调试版-v1.1.md 第 81 行
...
//
// 逐字来源（两处独立）：
//   - docs/01-设计/设计-协作骨架-v2.1.md 第 238 行（§4.6-7）：「**交接白名单 + `handoffs=["user"]`**……
//     **「人」是一等交接对象** ⇒ **「升级给人」统一为 handoff(user)**」；
//   - docs/01-设计/设计-内建调试版-v1.1.md 第 81 行：「与 autogen 的 **`handoffs=["user"]`** 同源 ⇒
//     两条独立来源印证，采之。」
