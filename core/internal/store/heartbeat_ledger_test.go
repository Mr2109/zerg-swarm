...
func TestHeartbeat_DecodeLedgerFields(t *testing.T) {
	...
	payload := []byte(`{
		...
		"resident":[
			{"alias":"example-35b","file":"/data/models/example-35b-v2.gguf","state":"ready","last_used_ago_s":3.2,"req_count":2,"rss_gb":22.3,"managed":true,"mem_gb":22,"ctx_window":262144,"source":"managed"},
